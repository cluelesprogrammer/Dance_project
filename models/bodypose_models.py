...
class new_bodypose_model(nn.Module):
	def __init__(self, paf_stages, conf_stages, train_features=0, batch_norm=True, final_activations=(None, None)):
...
class new_bodypose_model(nn.Module):
	def __init__(self, paf_stages, conf_stages, train_features=False, batch_norm=True, final_activations=(None, None)):
		super(new_bodypose_model, self).__init__()
		self.train_features = train_features
		self.model_type = 'new'
		# these layers have no relu layer
...
class bodypose_model(nn.Module):
	def __init__(self, n_stages=6, trained_model=True):
